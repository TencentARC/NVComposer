...
You can [try the demo](https://huggingface.co/spaces/l-li/NVComposer) of NVComposer on Hugging Face Space.
...
We are currently finalizing the procedures for open-sourcing the code, and it should be made available within a few days.
